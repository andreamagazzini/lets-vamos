import { Clock, Flame, Gauge, Heart, MapPin, Waves } from 'lucide-react';
...
export default function CardioFields({
  ...
  return (
    <>
      ...
      {/* Avg Speed - Available for all types */}
      <div>
        <label
          htmlFor="avgSpeed"
          className="flex items-center gap-2 text-sm font-semibold text-black mb-3"
      ...
      {/* Additional fields - Available for all types */}
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          <label htmlFor="laps" className="block text-sm font-semibold text-black mb-3">
            Laps
          </label>
          <input
            id="laps"
        ...
        <div>
          <label htmlFor="poolLength" className="block text-sm font-semibold text-black mb-3">
            Pool Length (m)
          </label>
          <input
            id="poolLength"
