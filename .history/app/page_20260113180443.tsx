        ...
        <div className="card-modern space-y-6">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full px-6 py-4 border-2 border-gray-200 rounded-full focus:outline-none focus:border-black focus:ring-0 transition-colors text-center font-semibold tracking-wider"
            />
            <button
